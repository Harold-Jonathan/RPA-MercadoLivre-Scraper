...
Este projeto de RPA foi desenvoldio usando **UiPath** para monitorar o mercado de memória RAM, no caso apenas a DDR4 mas podendo ser sobre qualquer produto do site em tempo real.
